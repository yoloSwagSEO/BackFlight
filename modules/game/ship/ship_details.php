<div class="panel">
    ...
    <span data-tooltip title='Gain : <?php echo round($MasterShipPlayer->getEnergyGain() / 3600 * GAME_SPEED, 2)?> energy / s'>Energy</span> <small>(<?php echo round($MasterShipPlayer->getEnergy())?> / <?php echo round($MasterShipPlayer->getEnergyMax())?>)</small>
